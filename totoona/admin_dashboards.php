...
// Function to render facilities on the admin dashboard
function renderFacilities() {
    ...
    <div class="facility-details">
        <div class="detail-item"><span class="label">Capacity:</span> <span>${facility.capacity}</span></div>
        <div class="detail-item"><span class="label">Amenities:</span> <span>${facility.amenities}</span></div>
        <div class="detail-item"><span class="label">Availability:</span> <span>${facility.availability}</span></div>
    </div>
...
// Load facilities from localStorage when the page loads
function loadFacilities() {
    const storedFacilities = localStorage.getItem("facilities");
    if (storedFacilities) {
        facilities = JSON.parse(storedFacilities);
    }
    renderFacilities(); // Render facilities after loading
}
                ...
                while ($row = $result->fetch_assoc()) {
                   ...
                   <div class="card" data-id="<?php echo $row['id']; ?>">
                        ...
                        <div class="card-content">
                            ...
                            <button class="delete-btn" onclick="deleteReservation(<?php echo $row['id']; ?>)">Delete</button> <!-- Add Delete Button -->
                                </div>
                        </div>
                    </div>
                    <?php
